...
<head>
    ...
    <meta property="og:url" content="https://colormagic.techkreative.com/generate-palette.php" />
    ...
    <link rel="canonical" href="https://colormagic.techkreative.com/generate-palette.php" />
...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white min-h-screen">
    ...
    <div id="mobileMenuOverlay"
        ...
        <div class="space-y-2">
            ...
            <a href="generate-palette.php" class="sb-btn sb-active w-full"><span class="sb-icon"><i
