...
<head>
    ...
    <meta name="description"
        content="Browse hundreds of beautiful CSS gradients — linear and radial. Copy ready-to-use CSS for your projects." />
...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white min-h-screen">
    ...
    <div id="mobileMenuOverlay"
        ...
        <div class="space-y-2">
            ...
            <a href="gradients" class="sb-btn sb-active w-full"><span class="sb-icon"><i
        ...
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400 text-base max-w-xl">
                    Browse beautiful linear &amp; radial gradients — filter by style, copy
    ...
    <script src="assets/js/gradients-page.js" defer></script>
</body>
