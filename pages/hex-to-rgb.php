...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white min-h-screen">
    ...
    <main class="w-full max-w-7xl mx-auto pt-16 pb-8 px-6 md:px-8 flex flex-col gap-6">
        ...
        <div
            ...
            <div
                class="absolute w-56 h-56 bg-secondary/15 rounded-full blur-[70px] top-[-30px] right-[-30px] pointer-events-none">
            </div>
            <div class="relative z-10">
                ...
                <p class="text-slate-600 dark:text-slate-300 text-base max-w-lg">
                    Convert hex color codes to RGB values in real-time. Use the hex-to-RGB converter above or the
                    RGB-to-hex converter below. See live color previews as you type.
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <h2 class="font-bold text-lg mb-4 flex items-center gap-2"><i
                    class="bi bi-arrow-right-circle text-primary"></i> Hex to RGB</h2>
            <div class="flex gap-4 flex-wrap items-start">
                ...
                <div id="hexToRgbResult"
                    class="flex-1 min-w-[220px] py-3.5 px-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 font-mono text-sm text-slate-600 dark:text-slate-300 min-h-[52px] flex items-center">
                    Enter a hex code above
                </div>
                <div id="hexPreview"
                    class="converter-preview w-14 h-14 rounded-xl border-2 border-slate-200 dark:border-slate-700 shrink-0"
        ...
        <div
            class="bg-white dark:bg-slate-900 p-5 md:p-7 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
            <h2 class="font-bold text-lg mb-4 flex items-center gap-2"><i
                    class="bi bi-arrow-left-circle text-secondary"></i> RGB to Hex</h2>
            <div class="flex gap-3 flex-wrap items-end">
                <div class="flex gap-2 flex-1 min-w-[220px]">
                    <div class="flex-1">
                        <label class="text-xs font-bold text-slate-400 uppercase mb-1 block">R</label>
                        <input id="rInput" type="number" min="0" max="255" placeholder="59"
                            class="w-full px-3 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 focus:border-primary focus:outline-none transition-all text-sm font-mono text-center" />
                    </div>
                    <div class="flex-1">
                        <label class="text-xs font-bold text-slate-400 uppercase mb-1 block">G</label>
                        <input id="gInput" type="number" min="0" max="255" placeholder="130"
                            class="w-full px-3 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 focus:border-primary focus:outline-none transition-all text-sm font-mono text-center" />
                    </div>
                    <div class="flex-1">
                        <label class="text-xs font-bold text-slate-400 uppercase mb-1 block">B</label>
                        <input id="bInput" type="number" min="0" max="255" placeholder="246"
                            class="w-full px-3 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 focus:border-primary focus:outline-none transition-all text-sm font-mono text-center" />
                    </div>
                </div>
                <div id="rgbToHexResult"
                    class="flex-1 min-w-[180px] py-3.5 px-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 font-mono text-sm text-slate-600 dark:text-slate-300 min-h-[52px] flex items-center">
                    Enter RGB values
                </div>
                <div id="rgbPreview"
                    class="converter-preview w-14 h-14 rounded-xl border-2 border-slate-200 dark:border-slate-700 shrink-0"
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 md:p-8 border border-slate-200 dark:border-slate-800">
            ...
            <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
                A hex color code consists of three pairs of hexadecimal digits: <code
                    class="font-mono text-primary">#RRGGBB</code>. Each pair represents one color channel (Red, Green,
                Blue) and converts to a decimal value between 0 and 255.
            </p>
            <div class="bg-slate-50 dark:bg-slate-800 rounded-xl p-4 font-mono text-sm mb-4 overflow-x-auto">
                ...
                <p class="text-slate-500 dark:text-slate-400 mt-1">Red: 3B₁₆ = 3×16 + 11 = <strong
                        class="text-primary">59</strong></p>
                <p class="text-slate-500 dark:text-slate-400">Green: 82₁₆ = 8×16 + 2 = <strong
                        class="text-primary">130</strong></p>
                <p class="text-slate-500 dark:text-slate-400">Blue: F6₁₆ = 15×16 + 6 = <strong
                        class="text-primary">246</strong></p>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#FF0000</td>
                            <td class="py-2.5 px-2 font-mono">rgb(255, 0, 0)</td>
                            <td class="py-2.5 px-2"><span class="w-6 h-6 rounded inline-block"
                                    style="background:#FF0000"></span> Red</td>
                        </tr>
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#00FF00</td>
                            <td class="py-2.5 px-2 font-mono">rgb(0, 255, 0)</td>
                            <td class="py-2.5 px-2"><span class="w-6 h-6 rounded inline-block"
                                    style="background:#00FF00"></span> Lime</td>
                        </tr>
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#0000FF</td>
                            <td class="py-2.5 px-2 font-mono">rgb(0, 0, 255)</td>
                            <td class="py-2.5 px-2"><span class="w-6 h-6 rounded inline-block"
                                    style="background:#0000FF"></span> Blue</td>
                        </tr>
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#FF5733</td>
                            <td class="py-2.5 px-2 font-mono">rgb(255, 87, 51)</td>
                            <td class="py-2.5 px-2"><span class="w-6 h-6 rounded inline-block"
                                    style="background:#FF5733"></span> Vermilion</td>
                        </tr>
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#EC4899</td>
                            <td class="py-2.5 px-2 font-mono">rgb(236, 72, 153)</td>
                            <td class="py-2.5 px-2"><span class="w-6 h-6 rounded inline-block"
                                    style="background:#EC4899"></span> Pink</td>
                        </tr>
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#3B82F6</td>
                            <td class="py-2.5 px-2 font-mono">rgb(59, 130, 246)</td>
                            <td class="py-2.5 px-2"><span class="w-6 h-6 rounded inline-block"
                                    style="background:#3B82F6"></span> Blue</td>
                        </tr>
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#10B981</td>
                            <td class="py-2.5 px-2 font-mono">rgb(16, 185, 129)</td>
                            <td class="py-2.5 px-2"><span class="w-6 h-6 rounded inline-block"
                                    style="background:#10B981"></span> Emerald</td>
                        </tr>
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#000000</td>
                            <td class="py-2.5 px-2 font-mono">rgb(0, 0, 0)</td>
                            <td class="py-2.5 px-2"><span
                                    class="w-6 h-6 rounded inline-block border border-slate-300 dark:border-slate-600"
                                    style="background:#000000"></span> Black</td>
                        </tr>
                        <tr>
                            <td class="py-2.5 px-2 font-mono font-bold">#FFFFFF</td>
                            <td class="py-2.5 px-2 font-mono">rgb(255, 255, 255)</td>
                            <td class="py-2.5 px-2"><span
                                    class="w-6 h-6 rounded inline-block border border-slate-300 dark:border-slate-600"
                                    style="background:#FFFFFF"></span> White</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400">RGB stands for Red, Green, Blue — the three
                        additive primary colors of light. Each channel has a value from 0 (none) to 255 (full
                        intensity). Combining all three channels produces the full spectrum of screen-displayable
                        colors.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">How do I convert hex to RGB manually?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">Split the hex code into three pairs (RR, GG,
                        BB), then convert each pair from base-16 to decimal. For example, #3B82F6 → 3B=59, 82=130,
                        F6=246 → RGB(59, 130, 246). Use our converter above for instant results.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">What's the difference between hex and RGB?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">They represent the same color data in
                        different formats. Hex uses base-16 notation (#RRGGBB), while RGB uses decimal values (0–255)
                        per channel. Hex is more compact; RGB is more intuitive for adjusting individual channels.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">Why use RGB instead of hex?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">RGB is preferred in CSS when you need to
                        manipulate individual color channels (e.g., rgba() for transparency), or when working with
                        design tools that use decimal values. Hex is more compact for simple color specification.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">What is RGB(255, 0, 0) in hex?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">RGB(255, 0, 0) is pure red, which is
                        <strong>#FF0000</strong> in hex. 255 in decimal = FF in hexadecimal, and 0 = 00. Use our
                        RGB-to-hex converter above for any conversion.</p>
                </div>
            </div>
        </div>
