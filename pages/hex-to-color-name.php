...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white min-h-screen">
    ...
    <main class="w-full max-w-7xl mx-auto pt-16 pb-8 px-6 md:px-8 flex flex-col gap-6">
        <!-- Hero -->
        <div
            class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-500/10 via-pink-50 to-fuchsia-500/10 dark:from-violet-500/20 dark:via-slate-900 dark:to-fuchsia-500/20 p-7 md:p-10 border border-violet-100 dark:border-slate-800">
            <div
                class="absolute w-56 h-56 bg-violet-500/15 rounded-full blur-[70px] top-[-30px] right-[-30px] pointer-events-none">
            </div>
            <div
                class="absolute w-44 h-44 bg-fuchsia-500/15 rounded-full blur-[55px] bottom-[-25px] left-[-25px] pointer-events-none">
            </div>
            <div class="relative z-10 flex flex-col md:flex-row md:items-center gap-7">
                <div class="flex-1">
                    <div
                        class="inline-flex items-center gap-2 px-3 py-1.5 bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-full text-xs font-bold text-violet-600 dark:text-violet-400 mb-3 border border-violet-200/50 dark:border-violet-700/50">
                    ...
                    <p class="text-slate-600 dark:text-slate-300 text-base max-w-lg">
                        Enter any hex code and instantly discover its human-readable color name. Our database includes
                        over 1,000 named colors — from Alice Blue to Zinc, and everything in between.
                    </p>
                </div>
                <div class="shrink-0 flex flex-col items-center gap-2">
                    ...
                    <span id="liveHexLabel"
                        class="text-sm font-mono font-bold text-slate-500 dark:text-slate-400">#EC4899</span>
                </div>
            </div>
        </div>
        ...
        <div class="my-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-10 h-10 rounded-lg shadow-sm shrink-0" style="background:#FF5733"></span>
                    <div>
                        <p class="font-bold text-sm">#FF5733</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Vermilion / Red-orange</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#EC4899</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Pink</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#3B82F6</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Blue (Tailwind 500)</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#10B981</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Emerald</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#8B5CF6</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Violet</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#F59E0B</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Amber</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#EF4444</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Red</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#06B6D4</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Cyan</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#84CC16</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Lime</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#191970</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Midnight Blue</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#FF6347</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Tomato</p>
                    </div>
                </div>
                <div
                    class="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div>
                        <p class="font-bold text-sm">#000000</p>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Black</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div
            class="bg-white dark:bg-slate-900 rounded-2xl p-6 md:p-8 border border-slate-200 dark:border-slate-800 mb-6">
            <h2 class="text-xl font-bold mb-4 text-slate-800 dark:text-white">How Hex Codes Map to Color Names</h2>
            <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
                A hex color code is a 6-digit hexadecimal number representing Red, Green, and Blue channels (e.g., <code
                    class="font-mono text-primary">#RRGGBB</code>). Each pair of digits ranges from 00 to FF (0–255 in
                decimal), giving over 16.7 million possible color combinations. Color names are human-readable labels
                assigned to specific hex values or the closest match in a named color database. When you enter a hex
                code, our converter finds the nearest named color by calculating the Euclidean distance in RGB space.
            </p>
            <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                Named colors come from standardized lists like CSS/X11 colors, as well as curated design palettes. While
                not every hex code has an exact name, our tool identifies the closest match from over 1,000 named
                entries.
            </p>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400">#FF5733 is a vibrant red-orange color,
                        commonly called Vermilion. It has RGB values of (255, 87, 51) and is a popular choice for
                        call-to-action buttons due to its energetic appearance.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">How to convert hex code to color name?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">Enter the hex code (with or without #) into
                        the converter above. It looks up the closest named color from a database of 1,000+ entries by
                        measuring the distance between colors in RGB space. The result includes the name, hex, RGB, and
                        HSL values.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">What are named colors?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">Named colors are specific hex color values
                        that have been given human-readable names. Examples include "Coral" (#FF7F50), "Dodger Blue"
                        (#1E90FF), and "Midnight Blue" (#191970). CSS supports 148 standard named colors, but extended
                        databases include thousands more.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">Where do color names come from?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">Color names originate from several sources:
                        the CSS/X11 color standard (148 names), the Resene colour dictionary, the XKCD color survey of
                        220,000 participants, and various design industry standards. Our database combines these sources
                        for comprehensive coverage.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">How many hex colors have names?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">Our database contains over 1,000 named colors.
                        While there are 16,777,216 possible hex combinations, only a fraction have widely recognized
                        names. For unnamed colors, our tool finds the closest named match so you always get a useful
                        result.</p>
                </div>
            </div>
        </div>
