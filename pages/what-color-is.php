...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white min-h-screen">
    ...
    <main class="w-full max-w-7xl mx-auto pt-16 pb-8 px-6 md:px-8 flex flex-col gap-6">
        <!-- Hero -->
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500/10 via-pink-50 to-orange-500/10 dark:from-amber-500/20 dark:via-slate-900 dark:to-orange-500/20 p-7 md:p-10 border border-amber-100 dark:border-slate-800">
            <div class="absolute w-56 h-56 bg-amber-500/15 rounded-full blur-[70px] top-[-30px] right-[-30px] pointer-events-none"></div>
            <div class="relative z-10 flex flex-col md:flex-row md:items-center gap-7">
                <div class="flex-1">
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-full text-xs font-bold text-amber-600 dark:text-amber-400 mb-3 border border-amber-200/50 dark:border-amber-700/50">
                    ...
                    <p class="text-slate-600 dark:text-slate-300 text-base max-w-lg">
                        Paste any hex code and we'll tell you exactly what color it is. Just type or paste the code below — no design software needed.
                    </p>
                </div>
                <div class="shrink-0 flex flex-col items-center gap-2">
                    <div id="livePreview" class="w-28 h-28 md:w-36 md:h-36 rounded-2xl shadow-2xl border-4 border-white dark:border-slate-700" style="background-color: #f59e0b"></div>
                    <span id="liveHexLabel" class="text-sm font-mono font-bold text-slate-500 dark:text-slate-400">#F59E0B</span>
                </div>
            </div>
        </div>
        ...
        <div class="my-6">
            ...
            <!-- Warm Colors -->
            <h3 class="text-sm font-bold text-slate-500 uppercase tracking-wider mb-3"><i class="bi bi-sun text-orange-500"></i> Warm Colors</h3>
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#FF0000"></span>
                    <p class="font-bold text-xs">#FF0000</p><p class="text-[10px] text-slate-500">Red</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#FF5733"></span>
                    <p class="font-bold text-xs">#FF5733</p><p class="text-[10px] text-slate-500">Vermilion</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#FF6347"></span>
                    <p class="font-bold text-xs">#FF6347</p><p class="text-[10px] text-slate-500">Tomato</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#FFA500"></span>
                    <p class="font-bold text-xs">#FFA500</p><p class="text-[10px] text-slate-500">Orange</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#FFD700"></span>
                    <p class="font-bold text-xs">#FFD700</p><p class="text-[10px] text-slate-500">Gold</p>
                </div>
            </div>

            <!-- Cool Colors -->
            <h3 class="text-sm font-bold text-slate-500 uppercase tracking-wider mb-3"><i class="bi bi-snow2 text-blue-500"></i> Cool Colors</h3>
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#0000FF"></span>
                    <p class="font-bold text-xs">#0000FF</p><p class="text-[10px] text-slate-500">Blue</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#3B82F6"></span>
                    <p class="font-bold text-xs">#3B82F6</p><p class="text-[10px] text-slate-500">Blue (Tailwind)</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#06B6D4"></span>
                    <p class="font-bold text-xs">#06B6D4</p><p class="text-[10px] text-slate-500">Cyan</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#10B981"></span>
                    <p class="font-bold text-xs">#10B981</p><p class="text-[10px] text-slate-500">Emerald</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#8B5CF6"></span>
                    <p class="font-bold text-xs">#8B5CF6</p><p class="text-[10px] text-slate-500">Violet</p>
                </div>
            </div>

            <!-- Neutral Colors -->
            <h3 class="text-sm font-bold text-slate-500 uppercase tracking-wider mb-3"><i class="bi bi-circle-half text-slate-500"></i> Neutral Colors</h3>
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm border border-slate-300 dark:border-slate-600" style="background:#FFFFFF"></span>
                    <p class="font-bold text-xs">#FFFFFF</p><p class="text-[10px] text-slate-500">White</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#C0C0C0"></span>
                    <p class="font-bold text-xs">#C0C0C0</p><p class="text-[10px] text-slate-500">Silver</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#808080"></span>
                    <p class="font-bold text-xs">#808080</p><p class="text-[10px] text-slate-500">Gray</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#8B4513"></span>
                    <p class="font-bold text-xs">#8B4513</p><p class="text-[10px] text-slate-500">Saddle Brown</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#F5F5DC"></span>
                    <p class="font-bold text-xs">#F5F5DC</p><p class="text-[10px] text-slate-500">Beige</p>
                </div>
            </div>

            <!-- Dark Colors -->
            <h3 class="text-sm font-bold text-slate-500 uppercase tracking-wider mb-3"><i class="bi bi-moon-stars text-indigo-500"></i> Dark Colors</h3>
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#000000"></span>
                    <p class="font-bold text-xs">#000000</p><p class="text-[10px] text-slate-500">Black</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#191970"></span>
                    <p class="font-bold text-xs">#191970</p><p class="text-[10px] text-slate-500">Midnight Blue</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#800020"></span>
                    <p class="font-bold text-xs">#800020</p><p class="text-[10px] text-slate-500">Burgundy</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#2F4F4F"></span>
                    <p class="font-bold text-xs">#2F4F4F</p><p class="text-[10px] text-slate-500">Dark Slate Gray</p>
                </div>
                <div class="flex flex-col items-center gap-2 p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <span class="w-12 h-12 rounded-lg shadow-sm" style="background:#006400"></span>
                    <p class="font-bold text-xs">#006400</p><p class="text-[10px] text-slate-500">Dark Green</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400">Enter the hex code into the search box above. Our tool matches it against a database of 1,000+ named colors and shows you the color name, RGB/HSL values, and a live preview. You can also see the color rendered visually before knowing its name.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">What color is #000000?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">#000000 is pure Black — the absence of all color light. In RGB, it's rgb(0, 0, 0), meaning zero intensity on all three channels. It's the darkest possible color and provides maximum contrast against white text.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">What color is #FFFFFF?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">#FFFFFF is pure White — full intensity on all RGB channels: rgb(255, 255, 255). It's the lightest possible color and serves as the default background for most web pages and documents.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">How to read a hex color code?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">A hex code has the format #RRGGBB where RR is Red, GG is Green, and BB is Blue. Each pair uses base-16 (0-9, A-F). Higher values = more of that color. For example, #FF0000 is maximum red (pure red), while #0000FF is maximum blue.</p>
                </div>
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-base mb-2">Where can I find hex codes for my colors?</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-400">Use our <a href="<?= $base ?>/find-color" class="text-primary hover:underline">Find Color tool</a> to look up any hex code's details, or browse our <a href="<?= $base ?>/palettes" class="text-primary hover:underline">Palette Explorer</a> for curated color schemes with ready-to-use hex codes. You can also pick colors from images using browser developer tools.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800/50 dark:to-slate-900/50 rounded-2xl p-8 mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <a href="<?= $base ?>/brand-color-lookup" class="flex items-center gap-3 p-3 bg-white dark:bg-slate-800 rounded-xl hover:shadow-md transition">
